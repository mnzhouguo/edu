...
import { BookMarked,BookOpenCheck,CalendarDays,ChevronDown,CirclePlus,ClipboardCheck,Gift,LayoutDashboard,Pencil,Target,UserRound } from 'lucide-react';
import { api } from './api';
...
type Page='today'|'plan'|'week'|'mistakes'|'rewards'|'dashboard';
const nav:[Page,string,typeof ClipboardCheck][]=[['today','今日看板',ClipboardCheck],['plan','学习规划',BookMarked],['week','周计划',CalendarDays],['mistakes','错题本',BookOpenCheck],['rewards','积分奖励',Gift],['dashboard','数据概览',LayoutDashboard]];
